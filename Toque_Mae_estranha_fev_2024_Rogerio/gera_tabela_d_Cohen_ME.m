...
writetable(T_Cohen_ME_hbo, diretorio_out + "d_Cohen_ME.xlsx", 'Sheet', 'd_Cohen_ME_hbo');
writetable(T_Cohen_ME_hbr, diretorio_out + "d_Cohen_ME.xlsx", 'Sheet', 'd_Cohen_ME_hbr');
...
for Nchan = lst_active_ME
    ...
    if i==1
        legend('HBO Mãe','HBR Mãe','HBO Estranha','HBR Estranha', 'Location', 'Best', 'FontSize', 6);
    end
    xlim([-3 25]);
